	...
	CREATE TABLE `frame_coordinates` (
        ...
        CONSTRAINT FK_music_TO_frame_coordinates FOREIGN KEY (music_id) REFERENCES music(id)
	);
	...
	(1, '00:00:13.200', '00:00:14.100', 0, 1),
	(2, '00:00:17.400', '00:00:18.300', 0, 2),
	(3, '00:00:21.000', '00:00:24.600', 10, 12),
	(4, '00:00:24.900', '00:00:28.200', 10, 11),
	(5, '00:00:29.100', '00:00:31.200', 4, 6),
	(6, '00:00:33.000', '00:00:34.500', 3, 4),
	(7, '00:00:36.600', '00:00:38.700', 4, 6),
	(8, '00:00:40.500', '00:00:42.400', 11, 12);
