...
import com.surocksang.domain.term.repository.TermRepository;
...
import com.surocksang.domain.user.dto.SignUpTermAgreement;
import com.surocksang.domain.user.repository.UserAgreementRepository;
...
import static com.surocksang.common.util.UriPathExtractor.getUriPath;
import static com.surocksang.domain.user.exception.UserErrorCode.DUPLICATE_EMAIL;
import static com.surocksang.domain.user.exception.UserErrorCode.DUPLICATE_NICKNAME;
import static com.surocksang.domain.user.exception.UserErrorCode.DUPLICATE_TERM_IN_REQUEST;
import static com.surocksang.domain.user.exception.UserErrorCode.REQUIRED_TERM_NOT_AGREED;
import static com.surocksang.domain.user.exception.UserErrorCode.TERM_SET_MISMATCH;
